    ...
    return (
        <Link to={`/video/${video?.videoId}`}>
            <div className="flex mb-3">
                <div className=" h-24 lg:h-20 xl:h-24 w-40 min-w-[168px] lg:w-32 lg:min-w-[128px] xl:w-40 xl:min-w-[168px] rounded-xl bg-slate-800 overflow-hidden">
                    <img
                ...
                <div className="flex flex-col ml-3 overflow-hidden">
                    <span className="text-sm text-left lg:text-xs xl:text-sm font-bold line-clamp-2 text-white">
                        {video?.title}
                    </span>
